...
BlockHeaderTestCase = None


def FuzzerInit(bls_disabled: bool) -> None:
    global BlockHeaderTestCase
    ...
    class BlockHeaderTestCaseImpl(spec.Container):
        pre: spec.BeaconState
        block: spec.BeaconBlock

    BlockHeaderTestCase = BlockHeaderTestCaseImpl


def FuzzerRunOne(input_data: bytes) -> typing.Optional[bytes]:
    test_case = BlockHeaderTestCase.decode_bytes(input_data)
